...
class Core {
     ...
     *                                         options are: draggable, can the user drag the bar
     * @return {number | string}               Returns the id of the new bar
     */
    addCustomTime(time, id, options) {
        ...
        const customTime = new CustomTime(this.body, util.extend({}, this.options, options, {
            time: timestamp,
            id,
